...
public class CharSequenceParseText implements ParseText {
...
//		return (ch>='A' && ch<='Z') ? ((char)(ch ^ 0x20)) : ch;
		...
		char a = charSequence.charAt(index);
	    char b = (a>='A' && a<='Z') ? ((char)(a ^ 0x20)) : a;
		char c = Debug.makeConcolicChar("sym_char_" + index, ""+(int)b);
	    return c;
	}
