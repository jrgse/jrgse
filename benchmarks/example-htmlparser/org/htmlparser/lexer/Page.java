        ...
        Serializable
{
    ...
    /**added by yhb to represent a successful parsing*/
    public void ending(){}
...
//                System.out.println (msg.toString ());
            ...
            ParserException
    {
        ...
        if (offset == i)
            ...
            {
                i = mSource.read ();
                if (Source.EOF == i) // can generate constraints!
                    ret = EOF;
                else
                {
                    ret = (char)i;
                    cursor.advance (); // move the cursor ahead!
                }
            }
            catch (IOException ioe)
            {
        ...
        // handle \r
        if ('\r' == ret) // can generate constraints!
