...
//          mOffset++;
        	 ...
        	 */
            char a = mString.charAt (mOffset);
            a = Debug.makeConcolicChar("sym_char_" + mOffset, ""+(int)a);
           // System.out.println("------" + mOffset + "--" + a + ":" + (int)a);
            mOffset++;
            return a;
        }
        return (ret);
...
//        	offset++ 
        	 ...
        	 * added by Zhenbang for introducing symbolic variables
        	 */
            char a = mString.charAt (offset);
            a = Debug.makeConcolicChar("sym_char_" + offset, ""+(int)a);
          //  System.out.println("------" + offset + "--" + a + ":" + (int)a);
            ret = a;
        }
