...
import test.htmlparser.TestHTMLParser;
        ...
        NodeFactory
{
            ...
            ParserException
    {
        ...
        switch (ch)  // generate constraints!
        {
            case Page.EOF:
                ret = null;
                break;
            case '<': // generate constraints!
                ch = mPage.getCharacter (mCursor);
                if (Page.EOF == ch)
            ...
            default:
                ...
                ret = parseString (start, quotesmart); // can generate constraints!
                break;
        }
            ...
            ParserException
    {
        ...
        quote = 0;
        while (!done) //this is a loop, until done!
        {
            ch = mPage.getCharacter (mCursor);
            if (Page.EOF == ch)
                done = true;
                ...
                case 2: // prior to the closing percent
                    switch (ch)
                    {
                        ...
                        case '/': // // or /*
                            ...
                            /*added by Zhenbang for fixing the infinite loop bug*/
                            else if (ch == Page.EOF){
                            	done = true;
                            	break;
                            }
