        ...
        Tag
{
    ...
    private CompositeTagScanner mScanner;
    
    /**
     * The default scanner for non-composite tags.
     */
    //protected final static CompositeTagScanner mDefaultScanner = new CompositeTagScanner();//TagScanner ();
    ...
    public TagNode (Page page, int start, int end, Vector attributes)
    {
        ...
        mScanner = new CompositeTagScanner();//(CompositeTagScanner)mDefaultScanner;
    ...
    public CompositeTagScanner getThisCompositeScanner ()
    {
        return mScanner;
    }
    ...
    {
        mScanner = (CompositeTagScanner)scanner;
    }
